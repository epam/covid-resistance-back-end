...
namespace Epam.CovidResistance.Services.User.IdentityServer.Persistence.Migrations.ConfigurationDB
{
    [DbContext(typeof(ISConfigurationDbContext))]
    internal class ISConfigurationDbContextModelSnapshot : ModelSnapshot
    {
