...
{
    public class ISPersistedGrantDbContext : PersistedGrantDbContext<ISPersistedGrantDbContext>
    {
        /// <summary>
        ...
        public ISPersistedGrantDbContext(DbContextOptions options, OperationalStoreOptions storeOptions)
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.HasDefaultSchema("grant");
        }
    }
}